function toggleSmoothScrolling(enable) {
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    checkoutButton.addEventListener('click', () => {
        ...
        cartItems.forEach((cartItem, index) => {
            ...
            queryParams.push(`product${index + 1}=${encodeURIComponent(productName)}&price${index + 1}=${encodeURIComponent(productPrice)}&image${index + 1}=${encodeURIComponent(productImageSrc)}`);
        });
